...
private:
   ...
   */
  double GetLoss (Ptr<ChannelCondition> cond, double distance2D, double distance3D, double hUt, double hBs, Ptr<MobilityModel> a,
   ...
   * \return pathloss value in dB
   */
  virtual double GetLossLos (double distance2D, double distance3D, double hUt, double hBs, Ptr<MobilityModel> a,
...
private:
   ...
   * \return pathloss value in dB
   */
  double GetLossLos (double distance2D, double distance3D, double hUt, double hBs, Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const override;
