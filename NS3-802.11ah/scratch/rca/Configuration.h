...
struct Configuration {
	...
	string RAWConfigFile = "./OptimalRawGroup/RawConfig-testing.txt";
	string DataMode = "MCS2_1"; //TODO copy this from Dwight, OfdmRate7_8MbpsBW2MHz MCS2
	...
	uint16_t sensorMeasurementSize = 150;// = 54; //1024
