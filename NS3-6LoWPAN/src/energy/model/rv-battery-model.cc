...
{
  NS_LOG_FUNCTION (this);
  //std::cout << "Voltage : " << GetSupplyVoltage() << std::endl;
...
RvBatteryModel::UpdateEnergySource (void)
{
  ...
  //std::cout << "Current : " << currentLoad << std::endl;
  ...
  //std::cout << "RvBatteryModel:Calculated alpha = " << calculatedAlpha <<
