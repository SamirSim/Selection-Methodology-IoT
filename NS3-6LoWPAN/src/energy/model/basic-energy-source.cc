...
{
  NS_LOG_FUNCTION (this);
  //std::cout << "Voltage : " << m_supplyVoltageV << std::endl;
...
BasicEnergySource::CalculateRemainingEnergy (void)
{
  ...
  //std::cout << Simulator::Now().GetSeconds() << " Current : " << totalCurrentA * 1000 << std::endl;
  ...
  //std::cout << Simulator::Now() << "Remaining energy : " << m_remainingEnergyJ << std::endl;
