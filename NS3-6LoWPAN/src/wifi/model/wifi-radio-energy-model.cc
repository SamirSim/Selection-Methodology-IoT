...
WifiRadioEnergyModel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::WifiRadioEnergyModel")
    ...
    .AddAttribute ("IdleCurrentA",
                   ...
                   //DoubleValue (0.273),  // TODO idle mode = 273mA
                   DoubleValue (0.001), // TODO Changed it
                   //DoubleValue (0.018), // Value from SIMUTools paper
    ...
    .AddAttribute ("CcaBusyCurrentA",
                   ...
                   //DoubleValue (0.107),  // default to be the same as idle mode
                   DoubleValue (0.001), // TODO Changed it
                   //DoubleValue (0.018), // Value from SIMUTools paper
    ...
    .AddAttribute ("TxCurrentA",
                   ...
                   DoubleValue (0.107), // TODO Changed it
                   //DoubleValue (0.085), // Value from SIMUTools paper
    ...
    .AddAttribute ("RxCurrentA",
                   ...
                   DoubleValue (0.04), // TODO Changed it
                   //DoubleValue (0.052), // Value from SIMUTools paper
    ...
    .AddTraceSource ("TxEnergyConsumption",
                     "Tx energy consumption of the radio device.",
                     MakeTraceSourceAccessor (&WifiRadioEnergyModel::m_txEnergyConsumption),
                     "ns3::TracedValueCallback::Double")
    .AddTraceSource ("RxEnergyConsumption",
                     "Rx energy consumption of the radio device.",
                     MakeTraceSourceAccessor (&WifiRadioEnergyModel::m_rxEnergyConsumption),
                     "ns3::TracedValueCallback::Double")
    .AddTraceSource ("BusyEnergyConsumption",
                     "Busy energy consumption of the radio device.",
                     MakeTraceSourceAccessor (&WifiRadioEnergyModel::m_busyEnergyConsumption),
                     "ns3::TracedValueCallback::Double")
    .AddTraceSource ("SwitchEnergyConsumption",
                     "Switch energy consumption of the radio device.",
                     MakeTraceSourceAccessor (&WifiRadioEnergyModel::m_switchEnergyConsumption),
                     "ns3::TracedValueCallback::Double")
    .AddTraceSource ("IdleEnergyConsumption",
                     "Tx energy consumption of the radio device.",
                     MakeTraceSourceAccessor (&WifiRadioEnergyModel::m_idleEnergyConsumption),
                     "ns3::TracedValueCallback::Double")
    .AddTraceSource ("SleepEnergyConsumption",
                     "Tx energy consumption of the radio device.",
                     MakeTraceSourceAccessor (&WifiRadioEnergyModel::m_sleepEnergyConsumption),
                     "ns3::TracedValueCallback::Double")
  ;
  return tid;
}
...
WifiRadioEnergyModel::GetTotalEnergyConsumption (void) const
{
  ...
  NS_LOG_UNCOND("Tx Energy : " << m_txEnergyConsumption);
  NS_LOG_UNCOND("Rx Energy : " << m_rxEnergyConsumption);
  NS_LOG_UNCOND("Busy Energy : " << m_busyEnergyConsumption);
  NS_LOG_UNCOND("Switching Energy : " << m_switchEnergyConsumption);
  NS_LOG_UNCOND("Idle Energy : " << m_idleEnergyConsumption);
  NS_LOG_UNCOND("Sleep Energy : " << m_sleepEnergyConsumption);
...
WifiRadioEnergyModel::ChangeState (int newState)
{
  ...
  if (m_currentState == WifiPhyState::TX) {
    //std::cout << "here TX " << std::endl;
    m_txEnergyConsumption += energyToDecrease;
  }
  else if (m_currentState == WifiPhyState::RX)
  {
    //std::cout << "here RX " << std::endl;
    m_rxEnergyConsumption += energyToDecrease;
  }
  else if (m_currentState == WifiPhyState::CCA_BUSY)
  {
    //std::cout << "here CCA_BUSY " << std::endl;
    m_busyEnergyConsumption += energyToDecrease;
  }
  else if (m_currentState == WifiPhyState::SWITCHING)
  {
    m_switchEnergyConsumption += energyToDecrease;
  }
  else if (m_currentState == WifiPhyState::IDLE)
  {
    m_idleEnergyConsumption += energyToDecrease;
  }
  else if (m_currentState == WifiPhyState::SLEEP)
  {
    m_sleepEnergyConsumption += energyToDecrease;
  }
  
  /*/
  std::cout << "TX : " << m_txEnergyConsumption << std::endl;
  std::cout << "RX : " << m_rxEnergyConsumption << std::endl;
  std::cout << "BUSY : " << m_busyEnergyConsumption << std::endl;
  std::cout << "SWITCH : " << m_switchEnergyConsumption << std::endl;
  std::cout << "IDLE : " << m_idleEnergyConsumption << std::endl;
  std::cout << "SLEEP : " << m_sleepEnergyConsumption << std::endl;
  /*/
