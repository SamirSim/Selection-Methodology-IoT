...
LorawanMacHelper::ApplyCommonAlohaConfigurations (Ptr<LorawanMac> lorawanMac) const
{
  ...
  ///////////////////////////////////////////////
  //TODO set SF here (not important)
  //lorawanMac->SetSfForDataRate (std::vector<uint8_t>{7,7,7,7,7,7,7});
...
LorawanMacHelper::ApplyCommonEuConfigurations (Ptr<LorawanMac> lorawanMac) const
{
  ...
  //TODO set SF here
  //lorawanMac->SetSfForDataRate (std::vector<uint8_t>{7,7,7,7,7,7,7});
  //lorawanMac->SetSfForDataRate (std::vector<uint8_t>{8,8,8,8,8,8,8});
  //lorawanMac->SetSfForDataRate (std::vector<uint8_t>{9,9,9,9,9,9,9});
  //lorawanMac->SetSfForDataRate (std::vector<uint8_t>{10,10,10,10,10,10,10});
  //lorawanMac->SetSfForDataRate (std::vector<uint8_t>{11,11,11,11,11,11,11});
  //lorawanMac->SetSfForDataRate (std::vector<uint8_t>{12,12,12,12,12,12,12});
  lorawanMac->SetSfForDataRate (std::vector<uint8_t>{12, 11, 10, 9, 8, 7, 7});
  lorawanMac->SetBandwidthForDataRate (
      std::vector<double>{125000, 125000, 125000, 125000, 125000, 125000, 250000});
  lorawanMac->SetMaxAppPayloadForDataRate (
  ...
  for (NodeContainer::Iterator j = endDevices.Begin (); j != endDevices.End (); ++j)
    {
      ...
      if (SF == 0) {
        ...
        sfQuantity[SF-7] = sfQuantity[SF-7] + 1;
      }
