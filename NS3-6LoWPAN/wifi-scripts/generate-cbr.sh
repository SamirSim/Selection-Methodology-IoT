...
declare -a simulationTime="100" # Seconds
    ...
    do
        ...
        do    
            ...
            then
                ...
                python3 get_latencies.py "${path}/latency/$nWifi-$dataRate-$MCS-$payloadSize-log-parsed.txt" "${path}/latency/$dataRate-$MCS-$payloadSize-$nWifi.csv"
            fi
